...
// POST /api/quizzes/:id/submit — Submit quiz answers (learners and admins)
router.post('/quizzes/:id/submit', authMiddleware, requireRole('learner', 'admin'), async (req: Request, res: Response) => {
  try {
